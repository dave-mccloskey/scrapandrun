...
DATABASES = {
    'default': {
        ...
        'NAME': '/home/dave/clothes.akwire.net/dbs/main.s3db',      # Or path to database file if using sqlite3.
...
STATICFILES_DIRS = (
    ...
    '/home/dave/clothes.akwire.net/site_root',
)
...
TEMPLATE_DIRS = (
    ...
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    '/home/dave/clothes.akwire.net/templates',
)
